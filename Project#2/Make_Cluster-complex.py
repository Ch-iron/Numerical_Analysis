...
X2 = np.random.normal(4, 2, 300)
Y2 = np.random.normal(4, 2, 300)
Z2 = np.random.normal(0, 10, 300)

X3 = np.random.normal(0, 10, 300)
Y3 = np.random.normal(0, 2, 300)
Z3 = np.random.normal(-4, 2, 300)

X4 = np.random.normal(-4, 2, 300)
Y4 = np.random.normal(-4, 2, 300)
Z4 = np.random.normal(4, 10, 300)

X5 = np.random.normal(15, 3, 300)
Y5 = np.random.normal(15, 3, 300)
Z5 = np.random.normal(15, 3, 300)
...
test_X2 = np.random.normal(4, 2, 100)
test_Y2 = np.random.normal(4, 2, 100)
test_Z2 = np.random.normal(0, 10, 100)

test_X3 = np.random.normal(0, 10, 100)
test_Y3 = np.random.normal(0, 2, 100)
test_Z3 = np.random.normal(-4, 2, 100)

test_X4 = np.random.normal(-4, 2, 100)
test_Y4 = np.random.normal(-4, 2, 100)
test_Z4 = np.random.normal(4, 10, 100)

test_X5 = np.random.normal(15, 3, 100)
test_Y5 = np.random.normal(15, 3, 100)
test_Z5 = np.random.normal(15, 3, 100)

test_X6 = np.random.normal(-12, 3, 100)
test_Y6 = np.random.normal(-12, 3, 100)
test_Z6 = np.random.normal(-12, 3, 100)
