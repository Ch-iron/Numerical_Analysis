...
Y1 = np.random.normal(0, 2, 300)
Z1 = np.random.normal(0, 6, 300)

X2 = np.random.normal(6, 5, 300)
Y2 = np.random.normal(4, 4, 300)
Z2 = np.random.normal(8, 3, 300)

X3 = np.random.normal(2, 2, 300)
Y3 = np.random.normal(6, 6, 300)
Z3 = np.random.normal(4, 2, 300)

X4 = np.random.normal(10, 3, 300)
Y4 = np.random.normal(10, 4, 300)
Z4 = np.random.normal(5, 2, 300)

X5 = np.random.normal(5, 4, 300)
Y5 = np.random.normal(-2, 2, 300)
Z5 = np.random.normal(6, 3, 300)
...
test_Y1 = np.random.normal(0, 2, 100)
test_Z1 = np.random.normal(0, 6, 100)

test_X2 = np.random.normal(6, 5, 100)
test_Y2 = np.random.normal(4, 4, 100)
test_Z2 = np.random.normal(8, 3, 100)

test_X3 = np.random.normal(2, 2, 100)
test_Y3 = np.random.normal(6, 6, 100)
test_Z3 = np.random.normal(4, 2, 100)

test_X4 = np.random.normal(10, 3, 100)
test_Y4 = np.random.normal(10, 4, 100)
test_Z4 = np.random.normal(5, 2, 100)

test_X5 = np.random.normal(5, 4, 100)
test_Y5 = np.random.normal(-2, 2, 100)
test_Z5 = np.random.normal(6, 3, 100)

test_X6 = np.random.normal(15, 2, 100)
test_Y6 = np.random.normal(15, 2, 100)
test_Z6 = np.random.normal(12, 2, 100)
